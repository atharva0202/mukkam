      ...
      <nav className="fixed top-0 w-full z-10 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          ...
          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
            ...
            <span
              className="userDropdownBtn hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
              onClick={(e) => history.push("/")}
            >
              Indore
              <div className="userDropdown absolute mt-1 bg-gray-200 rounded">
                      <Fragment>
                        <li className="flex flex-col text-gray-700 w-48 shadow-lg">
                        <span
                            onClick={(e) => history.push("/products/category/6177949cdb34ad3060df662f")}
                            className="flex space-x-2 py-2 px-8 hover:bg-gray-400 cursor-pointer"
                          >
                            <span>Shop 1</span>
                          </span>
                          <span
                            onClick={(e) => history.push("/products/category/617794b0db34ad3060df6633")}
                            className="flex space-x-2 py-2 px-8 hover:bg-gray-400 cursor-pointer"
                          >
                            <span>Shop 2</span>
                          </span>
            ...
            {/* <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
              onClick={(e) => history.push("/partials/Footer.js")}
            >
              Contact us
            </span> */}
          </div>
